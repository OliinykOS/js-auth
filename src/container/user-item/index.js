...
class UserItem extends List {
    constructor(){
        ...
        //this.id = new URL(location.href).searchParams.get('id') // пошук в посиланні параметра ?id=
        this.id = new URLSearchParams(location.search).get('id')  // другий варіант пошук в посиланні параметра ?id=
