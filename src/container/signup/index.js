...
class SignupForm extends Form{
    ...
    FIELD_ERROR = {
        ...
        EMAIL: 'Введіть коректне значення e-mail адреи',
        PASSWORD: 'Пароль повинен складатися з не менш ніж 8 символів, включаючи хоча б одну цифру, малу та велику літеру',
